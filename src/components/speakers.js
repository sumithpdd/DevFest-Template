...
const SpeakerProfiles = () => {
    ...
    const allowedSpeakers = [
        "Tom Colvin", "Natalie Godec", "Patty O'callaghan", "Marc Cohen",
        "Stefano Le Pera", "Steven Gray", "Sumith Damodaran", "Luiz Gustavo Martins",
        "Jose Enrique Calderon Sanz", "Alejandra Stamato", "Randy Gupta",
        "Vasudev Maduri", "Vadym Pinchuk", "Annalisa Arcella",
        "Mohammed Aboullaite", "Renuka Kelkar"
    ];
                                        ...
                                        {speaker.links.map(link => {
                                            ...
                                            return (
                                                <li key={speaker.lastName + link.linkType}>
                                                    <a href={link.url} className='hover:text-white' aria-label={link.linkType}>{icon}</a>
                                                </li>
                                            );
                                        })}
                                    </ul>
